...
class CAAudioConverter final {
  public:
    ...
    /// @throw std::system_error.
    void GetPropertyInfo(AudioConverterPropertyID inPropertyID, UInt32 *_Nullable outSize,
    ...
    /// @throw std::system_error.
    void ConvertComplexBuffer(UInt32 inNumberPCMFrames, const AudioBufferList *inInputData,
    ...
    /// @note The object assumes responsibility for disposing of the passed AudioConverter object using
