	...
	virtual std::string message(int condition) const override final
	{
		switch(static_cast<OSStatus>(condition)) {
			...
			case kAudio_MemFullError: 					return "Not enough room in heap zone";
				// AudioCodec.h
			case kAudioCodecUnspecifiedError: 			return "kAudioCodecUnspecifiedError";
			case kAudioCodecUnknownPropertyError: 		return "kAudioCodecUnknownPropertyError";
			case kAudioCodecBadPropertySizeError: 		return "kAudioCodecBadPropertySizeError";
			case kAudioCodecIllegalOperationError: 		return "kAudioCodecIllegalOperationError";
			case kAudioCodecUnsupportedFormatError: 	return "kAudioCodecUnsupportedFormatError";
			case kAudioCodecStateError: 				return "kAudioCodecStateError";
			case kAudioCodecNotEnoughBufferSpaceError: 	return "kAudioCodecNotEnoughBufferSpaceError";
			case kAudioCodecBadDataError: 				return "kAudioCodecBadDataError";
			default:									return "Unknown AudioCodec error";
		}
	}
};
...
public:
	...
	virtual std::string message(int condition) const override final
	{
		switch(static_cast<OSStatus>(condition)) {
			...
			case kAudio_MemFullError: 									return "Not enough room in heap zone";
				// ExtAudioFile.h
			case kExtAudioFileError_InvalidProperty:					return "kExtAudioFileError_InvalidProperty";
			case kExtAudioFileError_InvalidPropertySize: 				return "kExtAudioFileError_InvalidPropertySize";
			case kExtAudioFileError_NonPCMClientFormat: 				return "kExtAudioFileError_NonPCMClientFormat";
			case kExtAudioFileError_InvalidChannelMap: 					return "number of channels doesn't match format";
			case kExtAudioFileError_InvalidOperationOrder: 				return "kExtAudioFileError_InvalidOperationOrder";
			case kExtAudioFileError_InvalidDataFormat: 					return "kExtAudioFileError_InvalidDataFormat";
			case kExtAudioFileError_MaxPacketSizeUnknown: 				return "kExtAudioFileError_MaxPacketSizeUnknown";
			case kExtAudioFileError_InvalidSeek: 						return "writing, or offset out of bounds";
			case kExtAudioFileError_AsyncWriteTooLarge: 				return "kExtAudioFileError_AsyncWriteTooLarge";
			case kExtAudioFileError_AsyncWriteBufferOverflow: 			return "an async write could not be completed in time";
#if TARGET_OS_IPHONE
			case kExtAudioFileError_CodecUnavailableInputConsumed:		return "iOS only. Returned when ExtAudioFileWrite was interrupted. You must stop calling ExtAudioFileWrite. If the underlying audio converter can resume after an interruption (see kAudioConverterPropertyCanResumeFromInterruption), you must wait for an EndInterruption notification from AudioSession, and call AudioSessionSetActive(true) before resuming. In this situation, the buffer you provided to ExtAudioFileWrite was successfully consumed and you may proceed to the next buffer";
			case kExtAudioFileError_CodecUnavailableInputNotConsumed: 	return "iOS only. Returned when ExtAudioFileWrite was interrupted. You must stop calling ExtAudioFileWrite. If the underlying audio converter can resume after an interruption (see kAudioConverterPropertyCanResumeFromInterruption), you must wait for an EndInterruption notification from AudioSession, and call AudioSessionSetActive(true) before resuming. In this situation, the buffer you provided to ExtAudioFileWrite was not successfully consumed and you must try to write it again";
#endif /* TARGET_OS_IPHONE */
			default:													return "Unknown ExtAudioFile error";
		}
	}
};
